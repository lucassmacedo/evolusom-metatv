                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <h2 class="text-bold-700">{{ $data['geral']['clientes_atendidos'] }}</h2>
                        ...
                        <div class="col-lg-6 col-sm-12 col-12">
                            <div class="content-header row">
                                <div class="content-header-left col-md-12 col-12 mb-2">
                                    <div class="row breadcrumbs-top">
                                        <div class="col-12">
                                            <h2 class="content-header-title mb-0 width-95-per d-flex justify-content-between d-flex align-items-end">
                                                <i>FATURAMENTO</i>
                                            </h2>
                                        </div>
                                    </div>
                                                ...
                                                <td class="text-center" height="55">
                                                    <div class="row">
                                                        <div class="col-3 text-bold-700 font-medium-3 no-wrap text-right">
                                                            {{ round(($item->clientes_atendidos/$item->meta_clientes) * 100,2)  }}%
                                                        </div>
                                                        <div class="col">
