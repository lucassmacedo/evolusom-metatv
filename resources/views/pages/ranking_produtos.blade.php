    ...
    <section id="wishlist" class="grid-view wishlist-items">
        ...
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/1.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/2.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/3.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/4.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/5.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/6.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
                  <div class="badge badge-danger badge-md">
                    6 <i class="feather icon-star ml-25"></i>
                  </div>
                </div>
                <div>
                  <h6 class="item-price">
              ...
              <div>
                <p class="item-description">
                  Alienware Laptop: Bring video games to life with this 17.3-inch Dell Alienware laptop. It has a
                  powerful
                  quad-core Intel Core i7 processor and 16GB of DDR4 RAM to run modern games quickly, and its 1TB hard
                  drive stores plenty of game and other files. This Dell Alienware laptop has a 2.1 speaker
                  configuration
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/7.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
                  <div class="badge badge-danger badge-md">
                    7 <i class="feather icon-star ml-25"></i>
                  </div>
                </div>
                <div>
                  <h6 class="item-price">
              ...
              <div>
                <p class="item-description">
                  Enjoy smart access to videos, games and apps with this Amazon Fire TV stick. Its Alexa voice remote
                  lets
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/8.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
                  <div class="badge badge-danger badge-md">
                    8 <i class="feather icon-star ml-25"></i>
                  </div>
                </div>
                <div>
                  <h6 class="item-price">
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/9.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
                  <div class="badge badge-danger badge-md">
                    9 <i class="feather icon-star ml-25"></i>
                  </div>
                </div>
                <div>
                  <h6 class="item-price">
              ...
              <div>
                <p class="item-description">
                  Shoot professional photos and videos with this Canon EOS 5D Mk V 24-70mm lens kit. A huge
                  30.4-megapixel
                  full-frame sensor delivers outstanding image clarity, and 4K video is possible from this DSLR for
                  powerful films. Ultra-precise autofocus and huge ISO ranges give you the images you want from this
                  Canon
      ...
      <div class="card ecommerce-card">
        <div class="card-content">
          <a href="app-ecommerce-details">
            <div class="item-img text-center">
              <img src="http://full-version.test/images/pages/eCommerce/10.png" class="img-fluid" alt="img-placeholder">
            </div>
            <div class="card-body">
              <div class="item-wrapper">
                <div class="item-rating">
                  <div class="badge badge-danger badge-md">
                    10 <i class="feather icon-star ml-25"></i>
                  </div>
                </div>
                <div>
                  <h6 class="item-price">
              ...
              <div>
                <p class="item-description">
                  ...
                  Chef Collection refrigerator. It features 2 compressors, 3 evaporators and 4 temperature zones,
                  keeping
